...
{
    [TestClass]
    public class MakelaarDomainModelBuilderTests : BaseTest
    {
        private readonly IMakelaarDomainModelBuilder builder = new MakelaarDomainModelBuilder();

        [TestMethod]
        public void DependencyInjectionTest()
        {
            var result = this.DiContainer.GetInstance<IMakelaarDomainModelBuilder>();

            Assert.AreEqual(typeof(MakelaarDomainModelBuilder), result.GetType());
        }
